//
//  VSControllerDiscoverCell.swift
//  Snapchat
//
...
class VSControllerDiscoverCell: UICollectionViewCell {

    @IBOutlet weak var artworkContainer:UIImageView!;
    @IBOutlet weak var container:UIView!;
    @IBOutlet weak var discoverView:VSDiscoverView!;
    ...
    func setInformationOnView(){
         discoverView.viewDidLoad()
    }
